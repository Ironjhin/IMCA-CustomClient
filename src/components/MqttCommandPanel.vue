    ...
    <div v-if="activeTab === 'guard'" class="command-form">
      <div class="form-row">
        ...
        <select v-model.number="guard.commandId">
          ...
          <option :value="10">强化进攻</option>
          <option :value="11">强化防御</option>
          <option :value="12">强化移动</option>
        </select>
      </div>
...
async function sendMapClick(): Promise<void> {
  await sendMqttCommand('MapClickCmd', 'MapClickCmd', {
    ...mapClick,
